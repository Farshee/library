...
CREATE TABLE IF NOT EXISTS `branch_stock_transfer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `branch_stock_transfer_details`
--

CREATE TABLE IF NOT EXISTS `branch_stock_transfer_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `transfer_id` bigint(20) DEFAULT NULL,
  `product_id` bigint(20) DEFAULT NULL,
  `box_qty` float DEFAULT NULL,
  `u_qty` float DEFAULT NULL,
...
--
-- Table structure for table `branch_stock_transfer_receive_details`
--

CREATE TABLE IF NOT EXISTS `branch_stock_transfer_receive_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `transfer_id` bigint(20) DEFAULT NULL,
  `box_qty` float DEFAULT NULL,
  `u_qty` float DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `customer_information` (
  ...
  `is_diabetic_member` int(11) DEFAULT NULL,
...
INSERT INTO `customer_information` (`customer_id`, `customer_name`, `customer_address`, `address2`, `customer_mobile`, `customer_email`, `email_address`, `contact`, `phone`, `fax`, `city`, `state`, `zip`, `country`, `status`, `create_date`, `create_by`, `is_diabetic_member`, `card_number`) VALUES
(1, 'Walking Customer', '', '', '324234234', '', '', '', '', '', '', '', '', '', 1, '2021-01-06 23:33:34', '1', NULL, NULL);
--
...
--
-- Table structure for table `expiry_transfer`
--

CREATE TABLE IF NOT EXISTS `expiry_transfer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `transfer_id` varchar(25) DEFAULT NULL,
  `date` date NOT NULL,
  `from_warehouse` int(11) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `manufacturer_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `expiry_transfer_details`
--

CREATE TABLE IF NOT EXISTS `expiry_transfer_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `expiry_transfer_receive`
--

CREATE TABLE IF NOT EXISTS `expiry_transfer_receive` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `transfer_id` varchar(25) DEFAULT NULL,
  `date` date NOT NULL,
...
--
-- Table structure for table `expiry_transfer_receive_details`
--

CREATE TABLE IF NOT EXISTS `expiry_transfer_receive_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `transfer_id` varchar(30) DEFAULT NULL,
  `product_id` bigint(20) DEFAULT NULL,
  `quantity` float DEFAULT NULL,
...
(93, 'box_size', 'Pack Size', 'حجم مربع', NULL),
...
(113, 'box_qty', 'Pack Qty', 'مربع الكمية', NULL),
...
(405, 'box_pattern', 'Pack Pattern', NULL, NULL),
(406, 'box_mrp', 'Pack MRP', NULL, NULL),
...
(414, 'qty_box', 'QTY(Pack)', NULL, NULL),
...
(422, 'add_branch', 'Add Branch', NULL, NULL),
(423, 'branch_name', 'Branch Name', NULL, NULL),
(424, 'branch_address', 'Address', NULL, NULL),
(425, 'branch_prefix', 'Branch Prefix', NULL, NULL),
(426, 'database_host', 'Database Host', NULL, NULL),
(427, 'database_user', 'Database User', NULL, NULL),
(428, 'database_password', 'Database Password', NULL, NULL),
(429, 'database_port', 'Database Port', NULL, NULL),
(430, 'branch_separate_db', 'Branch Separate DB', NULL, NULL),
(431, 'branch_admin', 'Branch Admin', NULL, NULL),
(432, 'admin_email', 'Admin Email', NULL, NULL),
(433, 'admin_password', 'Admin Password', NULL, NULL),
(434, 'branch_list', 'Branch List', NULL, NULL),
(435, 'warehouse', 'Warehouse', NULL, NULL),
(436, 'add_warehouse', 'Add Warehouse', NULL, NULL),
(437, 'warehouse_list', 'Warehouse List', NULL, NULL),
(438, 'purchase_form', 'Purchase Form', NULL, NULL),
(439, 'location', 'Location', NULL, NULL),
(440, 'shelf', 'Shelf', NULL, NULL),
(441, 'add_shelf', 'Add Shelf', NULL, NULL),
(442, 'shelf_list', 'Shelf List', NULL, NULL),
(443, 'add_drawer', 'Add Drawer', NULL, NULL),
(444, 'drawer_list', 'Drawer List', NULL, NULL),
(445, 'number_of_drawer', 'Number Of Drawer', NULL, NULL),
(446, 'vat_rate', 'VAT RATE(%)', NULL, NULL),
(447, 'created_by', 'Created By', NULL, NULL),
(448, 'doctor', 'Doctor', NULL, NULL),
(449, 'add_doctor', 'Add Doctor', NULL, NULL),
(450, 'doctor_list', 'Doctor List', NULL, NULL),
(451, 'doctor_name', 'Doctor Name', NULL, NULL),
(452, 'education', 'Education', NULL, NULL),
(453, 'hospital_name', 'Hospital Name', NULL, NULL),
(454, 'doctor_id', 'Doctor Id', NULL, NULL),
(455, 'pack', 'Pack', NULL, NULL),
(456, 'shelf_setting', 'Shelf Settings', NULL, NULL),
(457, 'product_name', 'Product Name', NULL, NULL),
(458, 'select_shelf', 'Select Shelf', NULL, NULL),
(459, 'drawer', 'Drawer', NULL, NULL),
(460, 'select_drawer', 'Select Drawer', NULL, NULL),
(461, 'drawer_stock', 'Drawer Stock', NULL, NULL),
(462, 'is_localmarket', 'Is Local Market?', NULL, NULL),
(463, 'localmarket_purchase', 'Local market Purchase', NULL, NULL),
(464, 'localmarket_purchase_list', 'Localmarket Purchase List', NULL, NULL),
(465, 'pending_invoice_list', 'Pending Invoice List', NULL, NULL),
(466, 'is_diabetic_member', 'Is Diabetic Member ?', NULL, NULL),
(467, 'sms_configuration', 'SMS Configuration', NULL, NULL),
(468, 'card_number', 'Card Number', NULL, NULL),
(469, 'stock_transfer', 'Stock Transfer', NULL, NULL),
(470, 'from_warehouse', 'From Warehouse', NULL, NULL),
(471, 'to_warehouse', 'To Warehouse', NULL, NULL),
(472, 'stock_transfer_list', 'Stock Transfer List', NULL, NULL),
(473, 'warehouse_wise_stock', 'Warehouse Wise Stock', NULL, NULL),
(474, 'branchwise_stock_transfer', 'Branch Wise Stock Transfer', NULL, NULL),
(475, 'branchwise_stock_transfer_list', 'Branch Wise Transfer List', NULL, NULL),
(476, 'to_branch', 'To Branch', NULL, NULL),
(477, 'branch_stock_transfer_receive', 'Branch Stock Transfer Receive', NULL, NULL),
(478, 'from_branch', 'From Branch', NULL, NULL),
(479, 'is_formulation', 'Is Formulation', NULL, NULL),
(480, 'commission', 'Commission', NULL, NULL),
(481, 'expiry_management', 'Expiry Management', NULL, NULL),
(482, 'transfer_expiry', 'Transfer Expiry', NULL, NULL),
(483, 'expiry_trnasfer_list', 'Expiry Transfer List', NULL, NULL),
(484, 'expiry_trnasfer_receive_list', 'Expiry Transfer Receive List', NULL, NULL),
(485, 'expiry_balance', 'Expiry Balance', NULL, NULL),
(486, 'expiry_purchase_form', 'Expiry Purchase Form', NULL, NULL),
(487, 'expiry_purchase_list', 'Expiry Purchase List', NULL, NULL),
(488, 'add_return_invoice_less', 'Add Return (Invoice Less)', NULL, NULL),
(489, 'invoice_less_return_list', 'Return List (Invoice Less)', NULL, NULL),
(490, 'return_id', 'Return Id', NULL, NULL),
(491, 'sales_return', 'Sales Return', NULL, NULL),
(492, 'manufacturer_return_report', 'Manufacturer Return Report', NULL, NULL),
(493, 'tax_report', 'Tax Report', NULL, NULL),
(494, 'due_report', 'Due Report', NULL, NULL),
(495, 'profit_report', 'Profit Report (Sales wise)', NULL, NULL),
(496, 'daily_report', 'Daily Report', NULL, NULL),
(497, 'daily_customer_receipt', 'Daily Customer Receipt', NULL, NULL),
(498, 'total_profit', 'Total Profit', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `manufacturer_information` (
  ...
  `is_localmarket` int(11) DEFAULT NULL,
  `expiry_balance` float DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `manufacturer_information` (`id`, `manufacturer_id`, `manufacturer_name`, `address`, `address2`, `mobile`, `emailnumber`, `email_address`, `contact`, `phone`, `fax`, `city`, `state`, `zip`, `country`, `details`, `status`, `is_localmarket`, `expiry_balance`) VALUES
(1, 1, 'Aci', '', '', '2342342', 'aci@gmail.com', '', '', '', '', '', '', '', '', NULL, 1, 0, NULL),
(2, 2, 'Raihan', '', '', '234234', '', '', '', '', '', '', '', '', '', NULL, 1, 1, NULL),
(3, 3930746430, 'Salman Farshee', '', '', '234234333', 'salman@gmail.com', '', '', '', '', '', '', '', '', NULL, 1, 0, NULL),
(4, 4349272067, 'Saifullah', '', '', '325684', 'saifullah@gmail.com', '', '', '', '', '', '', '', '', NULL, 1, 0, NULL),
(5, 9192075690, 'Square', '', '', '012351420', 'square@gmail.com', '', '', '', '', '', '', '', '', NULL, 1, 0, NULL),
(6, 9656979758, 'Habibur Rahman', '', '', '23434222', 'habibur@gmail.com', '', '', '', '', '', '', '', '', NULL, 1, 0, 71.52);
...
CREATE TABLE IF NOT EXISTS `master_branch` (
  ...
  `branch_prefix` varchar(100) DEFAULT NULL,
  `database_host` varchar(250) DEFAULT NULL,
  `database_user` varchar(100) DEFAULT NULL,
  `database_password` varchar(50) DEFAULT NULL,
  `database_port` int(6) DEFAULT NULL,
  `branch_separate_db` tinyint(2) DEFAULT NULL,
  `branch_admin` varchar(150) DEFAULT NULL,
...
INSERT INTO `master_branch` (`id`, `branch_name`, `branch_address`, `branch_prefix`, `database_host`, `database_user`, `database_password`, `database_port`, `branch_separate_db`, `branch_admin`, `admin_email`, `admin_password`, `branch_url`, `status`) VALUES
(2, 'Bdtask', 'Khilkhet', 'bdtask_db', 'localhost', 'root', '', 3306, 0, 'Bdtask Ltd', 'bdtask@gmail.com', '123456', NULL, 1),
(3, 'Khilkhete', 'Nikunjo', 'khilkhet_db', 'localhost', 'root', '', 3306, 0, 'Demo User', 'demo@gmail.com', '1234567', NULL, 1),
(4, 'Expiry', 'Demo Streat', 'pcare_expiry_branch', 'localhost', 'root', '', 3306, 0, 'Branch admin', 'admin@email.com', '123456', NULL, 1);
...
INSERT INTO `medicine_leaf_setting` (`id`, `leaf_type`, `total_number`) VALUES
(1, '1X10', 10);
...
CREATE TABLE IF NOT EXISTS `product_information` (
  ...
  `image` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` int(11) NOT NULL,
  `is_formulation` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
  KEY `manufacturer_id` (`manufacturer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `product_invoice_less_return`
--

CREATE TABLE IF NOT EXISTS `product_invoice_less_return` (
  `id` int(11) NOT NULL,
  ...
  `invoice_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `date_return` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `batch_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `expeire_date` varchar(50) DEFAULT NULL,
  `ret_qty` decimal(10,2) DEFAULT NULL,
  `customer_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `manufacturer_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `product_purchase` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chalan_no` bigint(30) DEFAULT NULL,
  ...
  `is_localmarket` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `manufacturer_id` (`manufacturer_id`),
...
CREATE TABLE IF NOT EXISTS `product_purchase_details` (
  ...
  `dis_percentage` float DEFAULT NULL,
...
--
-- Table structure for table `product_purchase_details_expiry`
--

CREATE TABLE IF NOT EXISTS `product_purchase_details_expiry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `purchase_id` bigint(20) NOT NULL,
  `product_id` varchar(30) COLLATE utf8_unicode_ci NOT NULL,
  `quantity` float DEFAULT NULL,
...
--
-- Table structure for table `product_purchase_expiry`
--

CREATE TABLE IF NOT EXISTS `product_purchase_expiry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chalan_no` bigint(30) DEFAULT NULL,
  `manufacturer_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `grand_total_amount` decimal(12,2) NOT NULL DEFAULT 0.00,
...
--
-- Table structure for table `receive_branch_stock`
--

CREATE TABLE IF NOT EXISTS `receive_branch_stock` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `transfer_id` bigint(20) DEFAULT NULL,
  `from_branch` varchar(220) DEFAULT NULL,
  `from_warehouse` int(11) DEFAULT NULL,
  `to_warehouse` int(11) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `description` text DEFAULT NULL,
  `transfer_by` varchar(220) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `setting` (`id`, `title`, `menu_title`, `address`, `email`, `phone`, `logo`, `login_background`, `favicon`, `language`, `currency`, `rtl`, `discount_type`, `vat_rate`, `timezone`, `footer_text`, `update_notification`) VALUES
(1, 'Bdtask Ltd', 'pharmacare', 'Demo Address', 'bdtask@gmail.com', '00123456734', '/assets/dist/img/logo/1610774737_a80f4e581f1e063f13a7.png', '/assets/dist/img/logo/1613647690_9a202d45c2902dd82b57.jpg', '/assets/dist/img/favicon/1612675588_2e4ae5951792e016e4c5.png', 'english', '৳', 0, 1, 4, 'Asia/Dhaka', 'Copyright@bdtaskkk', 1);

-- --------------------------------------------------------

--
-- Table structure for table `shelf_setting`
--

CREATE TABLE IF NOT EXISTS `shelf_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `sms_settings` (`id`, `api_key`, `api_secret`, `from`, `isinvoice`) VALUES
(1, '5d6db020', 'mBD7S1RKDhD2lfcQ', '8801955110016', 1);
...
CREATE TABLE IF NOT EXISTS `stock_transfer` (
  ...
  `description` text DEFAULT NULL,
  `transfer_by` int(11) DEFAULT NULL,
  `f_wh` int(11) DEFAULT NULL,
  `t_wh` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Admin ', 'User', '', 'admin@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', NULL, '/assets/dist/img/user/1610013835_02bd092e4cb106d94293.jpg', '2021-04-10 03:25:14', '2021-04-10 03:29:02', '::1', 1, 1, NULL);
...
CREATE TABLE IF NOT EXISTS `warehouse` (
  ...
  `status` tinyint(4) DEFAULT NULL,
  `is_default_warehouse` int(11) DEFAULT NULL,
...
--
-- Table structure for table `wh_drawer`
--

CREATE TABLE IF NOT EXISTS `wh_drawer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shelf_id` int(11) DEFAULT NULL,
  `number_of_drawer` int(11) DEFAULT NULL,
  `drawer_name` varchar(150) DEFAULT NULL,
  `created_date` date NOT NULL DEFAULT current_timestamp(),
  `created_by` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `wh_shelf`
--

CREATE TABLE IF NOT EXISTS `wh_shelf` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
