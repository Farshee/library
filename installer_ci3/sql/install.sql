...
INSERT INTO `language` (`id`, `phrase`, `english`) VALUES(1005, 'tot_before_dis', 'Total Befor Discount');
...
INSERT INTO `web_setting` (`setting_id`, `logo`, `invoice_logo`, `favicon`, `currency`, `timezone`, `currency_position`, `footer_text`, `language`, `rtr`, `captcha`, `is_qr`, `site_key`, `secret_key`, `discount_type`) VALUES(1, '', '', '', '$', 'Asia/Dhaka', '0', 'Developed by  Bdtask bdtask', 'english', '0', 1, 1, '6LdiKhsUAAAAAMV4jQRmNYdZy2kXEuFe1HrdP5tt', '6LdiKhsUAAAAAMV4jQRmNYdZy2kXEuFe1HrdP5tt', 1);
